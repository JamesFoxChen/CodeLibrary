<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="CL.Web.Background.Pages.Product.ProductList" %>
    ...
    <div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body mws-form">
            <div class="mws-form-row">
                产品名称：<asp:TextBox ID="txtProductName" runat="server" CssClass="mws-textinput"></asp:TextBox>
        ...
        <div class="mws-panel-header">
            <span class="mws-i-24 i-table-1">产品管理</span>
        </div>
        <div class="mws-panel-toolbar top clearfix">
            <ul>
                <li><a href="ProductEdit.aspx" class="mws-ic-16 ic-accept">添加</a></li>
            </ul>
        </div>
                    ...
                    <asp:Repeater ID="rpt" runat="server" OnItemCommand="rpt_ItemCommand">
                        <ItemTemplate>
                            <tr class="gradeX">
                                ...
                                <td>
                                    <a href="ProductEdit.aspx?id=<%#Eval("ID") %>">修改</a>
