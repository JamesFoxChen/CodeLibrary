...
namespace Qiniu.RS
{
	...
	public class RSClient : QiniuAuthClient
	{
        ...
        {
            return CallWithBinary(QiniuConfig.RS_HOST + "/batch", "application/x-www-form-urlencoded", StreamEx.ToStream(requestBody), requestBody.Length);
        }	
